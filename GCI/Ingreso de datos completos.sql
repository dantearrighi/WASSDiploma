...
('Alta Comitente.', 'http://youtu.be/ekxqjXbc8os'),
('Alta Expediente.', 'http://youtu.be/phSBphgOalQ'),
('Alta Grupo.', 'http://youtu.be/ZoEIYS0u5Nc'),
('Alta Perfil.', 'http://youtu.be/7m7jNaDFAYM'),
('Alta Plan Título.', 'http://youtu.be/7m7jNaDFAYM'),
('Alta Profesional.', 'http://youtu.be/bBUc5dYCh_8'),
('Alta Tarea.', 'http://youtu.be/RtvYY17n6Mw'),
('Alta Título.', 'http://youtu.be/3WkONRvwdms'),
('Alta Título Profesional.', 'http://youtu.be/jx3Nyf4dINE'),
('Alta Usuario.', 'http://youtu.be/SjkdA6icoPY'),
('Baja Comitente.', 'http://youtu.be/L0Rc6n8S6pI'),
('Baja Grupo.', 'http://youtu.be/ym-OxkgVt9c'),
('Baja Perfil.', 'http://youtu.be/QdNRgNJMoFU'),
('Baja Plan Título.', 'http://youtu.be/AoRcWnRDdAY'),
('Baja Tarea.', 'http://youtu.be/QLltEf7DSiQ'),
('Baja Título.', 'http://youtu.be/ydcn_4_lw4s'),
('Baja Usuario.', 'http://youtu.be/9-JXTOJcBKQ'),
('Cambiar clave.', 'http://youtu.be/BwpHL9HecLM'),
('Cobrar Cuota.', 'http://youtu.be/QbywlUOLjYM'),
('Cobrar e Imprimir Recibo Cuota.', 'http://youtu.be/4EyJ4dTAd_0'),
('Cobrar e Imprimir Recibo Expediente.', 'http://youtu.be/4EyJ4dTAd_0'),
('Cobrar Expediente.', 'http://youtu.be/4EyJ4dTAd_0'),
('Consulta Profesional.', 'http://youtu.be/An4CZbCJW38'),
('Consulta Título.', 'http://youtu.be/RF7pQ3U3xjE'),
('Consultar Comitente.', 'http://youtu.be/Vu8sBu41t5I'),
('Consultar Expediente.', 'http://youtu.be/Davkido3p1Y'),
('Consultar Grupo.', 'http://youtu.be/js1bRi6JQvk'),
('Consultar Perfil.', 'http://youtu.be/YQk2vtX1A7Q'),
('Consultar Tarea.', 'http://youtu.be/HxdXYqDgXQ4'),
('Consultar Usuario.', 'http://youtu.be/ukq1llRdF8A'),
('Eliminar Profesional Expediente.', 'http://youtu.be/lF4cvKj6lzI'),
('Emitir Estadistica.', 'http://youtu.be/CexT6GklTF8'),
('Generar Corrimiento.', 'http://youtu.be/QvBucFRZcyw'),
('Generar Cuota.', 'http://youtu.be/F52XaGzKaLQ'),
('Gestion Recibos.', 'http://youtu.be/F1r80gxwn8s'),
('Gestionar Comitentes.', 'http://youtu.be/Odn2HAzeCXU'),
('Gestionar Cuotas.', 'http://youtu.be/VcEo6uFK1Ow'),
('Gestionar Expedientes.', 'http://youtu.be/aUfrxfJlMM8'),
('Gestionar Grupos.', 'http://youtu.be/lmLOp2uX1qo'),
('Gestionar Perfiles.', 'http://youtu.be/U_AL9CMif5Q'),
('Gestionar Profesionales.', 'http://youtu.be/VfxuEt9M2pA'),
('Gestionar Tareas.', 'http://youtu.be/eQ_7wCn6Sl0'),
('Gestionar Títulos.', 'http://youtu.be/9L9cXGM86mo'),
('Gestionar Usuarios.', 'http://youtu.be/pS0WYjBi6Ew'),
('Imprimir Certificado.', 'http://youtu.be/wGqKZg-LeEc'),
('Liquidar Expediente.', 'http://youtu.be/5SuJTsx8XUE'),
('Liquidar Expediente FE.', 'http://youtu.be/5SuJTsx8XUE'),
('Liquidar Expediente HM.', 'http://youtu.be/5SuJTsx8XUE'),
('Liquidar Expediente OI.', 'http://youtu.be/5SuJTsx8XUE'),
('Login.', 'http://youtu.be/P_5xAZlagtA'),
('Modificar Plan Título.', 'http://youtu.be/mJeB26ewZ2M'),
('Modificar Profesional.', 'http://youtu.be/NMN4BMO-8WM'),
('Modificar Título.', 'http://youtu.be/naQWwT9B4ec'),
('Modificar Título Profesional.', 'http://youtu.be/Wcf3k2UgZbo'),
('Modificar Alteradores Cuota.', 'http://youtu.be/amR4JDMpwwE'),
('Modificar Comitente.', 'http://youtu.be/-Lp5ECZM5JY'),
('Modificar Expediente.', 'http://youtu.be/obYf6UeG74I'),
('Modificar Grupo.', 'http://youtu.be/NCF_xg3K5fs'),
('Modificar Perfil.', 'http://youtu.be/bMnRWuq8eC0'),
('Modificar Tarea.', 'http://youtu.be/QI8lrBoUPeE'),
('Modificar Usuario.', 'http://youtu.be/l48Yxt-0AwE'),
('Reimprimir Boleta Profesional.', 'http://youtu.be/TCdwJTdbT2o'),
('Resetear clave.', 'http://youtu.be/VohxDR1dR30'),
('Seleccionar Comitente.', 'http://youtu.be/9RAwri3hqcI'),
('Seleccionar Profesional.', 'http://youtu.be/rn_aTTO8Zqk'),
('Suspender Profesional.', 'http://youtu.be/69nDKhw4Jpk'),
('Gestionar Auditorias.', 'http://youtu.be/g_ITmOeT6ok'),
('Gestionar Auditorias Cuotas.', 'http://youtu.be/CAnTmA8tTno'),
('Gestionar Ayuda.', 'http://youtu.be/7-suetAYq2c')
