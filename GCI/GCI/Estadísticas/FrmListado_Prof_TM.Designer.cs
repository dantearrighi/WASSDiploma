namespace GCI
{
    partial class FrmListado_Prof_TM
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Listados_Prof_TM = new GCI.Listados_Prof_TM();
            this.reportViewer1 = new Microsoft.Reporting.WinForms.ReportViewer();
            this.ProfesionalesTableAdapter = new GCI.Listados_Prof_TMTableAdapters.ProfesionalesTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GCI.Estadísticas.Profesionales_Por_TM.rdlc";
