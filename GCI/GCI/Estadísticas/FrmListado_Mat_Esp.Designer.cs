namespace GCI
{
    partial class FrmListado_Mat_Esp
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Listados_Mat_Esp = new GCI.Listados_Mat_Esp();
            this.ProfesionalesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.ProfesionalesTableAdapter = new GCI.Listados_Mat_EspTableAdapters.ProfesionalesTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GCI.Estadísticas.Matriculas_Por_Esp.rdlc";
