namespace WASSTD
{
    partial class FrmImprimirCertificado_I
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Certificado_Prof_I = new WASSTD.Certificado_Prof_I();
            this.ProfesionalesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.ProfesionalesTableAdapter = new WASSTD.Certificado_Prof_ITableAdapters.ProfesionalesTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WASSTD.Profesional.Certificado_Incumbencias.rdlc";
