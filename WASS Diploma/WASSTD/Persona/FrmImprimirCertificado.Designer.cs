namespace WASSTD
{
    partial class FrmImprimirCertificado
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Certificado_Prof = new WASSTD.Certificado_Prof();
            this.ProfesionalesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.ProfesionalesTableAdapter = new WASSTD.Certificado_ProfTableAdapters.ProfesionalesTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WASSTD.Profesional.Certificado_Habilitación.rdlc";
