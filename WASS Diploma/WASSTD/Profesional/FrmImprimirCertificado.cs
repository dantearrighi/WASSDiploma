...
namespace WASSTD
{
    public partial class FrmImprimirCertificado : Form
    {
        string icie_prof;

        public FrmImprimirCertificado(string icie)
        {
            InitializeComponent();
            icie_prof = icie;
        }
        ...
        private void FrmImprimirCertificado_Load(object sender, EventArgs e)
        {
            ...
            this.ProfesionalesTableAdapter.Fill(this.Certificado_Prof.Profesionales, icie_prof);
