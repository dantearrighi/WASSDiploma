namespace WASSTD
{
    partial class FrmListado_Cuotas_Esp
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Listado_Cuotas_Esp = new WASSTD.Listado_Cuotas_Esp();
            this.MovimientosBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.MovimientosTableAdapter = new WASSTD.Listado_Cuotas_EspTableAdapters.MovimientosTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WASSTD.Estadísticas.Cuotas_Por_Esp.rdlc";
