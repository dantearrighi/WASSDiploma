namespace WASSTD
{
    partial class FrmListado_Cuotas_Desc
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Listados_Cuotas_Desc = new WASSTD.Listados_Cuotas_Desc();
            this.reportViewer1 = new Microsoft.Reporting.WinForms.ReportViewer();
            this.MovimientosTableAdapter = new WASSTD.Listados_Cuotas_DescTableAdapters.MovimientosTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WASSTD.Estadísticas.Cuotas_Por_Desc.rdlc";
