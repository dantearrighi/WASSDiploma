namespace WASSTD
{
    partial class FrmListado_Expte_Monto_Esp
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Listado_Exptes_Monto_Esp = new WASSTD.Listado_Exptes_Monto_Esp();
            this.MovimientosBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.MovimientosTableAdapter = new WASSTD.Listado_Exptes_Monto_EspTableAdapters.MovimientosTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WASSTD.Estadísticas.Expedientes_Por_Monto_Esp.rdlc";
