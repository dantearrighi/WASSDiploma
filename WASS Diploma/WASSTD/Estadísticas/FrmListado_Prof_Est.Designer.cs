namespace WASSTD
{
    partial class FrmListado_Prof_Est
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Listados_Profesionales = new WASSTD.Listados_Profesionales();
            this.ProfesionalesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.ProfesionalesTableAdapter = new WASSTD.Listados_ProfesionalesTableAdapters.ProfesionalesTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WASSTD.Estadísticas.Profesionales_Por_Estado.rdlc";
